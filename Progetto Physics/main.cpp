...
int main(int argc, char **argv)
{
	...
	material.dynamicFriction = 5;
	material.elasticity = 400.0f;
	material.staticFriction = 5;
	...
	transformSphere2.position = Vector3(3.0f, 0, -20.0);
	...
	world.getBody(1).setAngularMomentum(Vector3(0, 0, 2));
